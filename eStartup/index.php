...
<body>
    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="#features">Comics</a></li>
  ...
  <section id="hero" class="wow fadeIn">
    <div class="hero-container">
      <h1>Welcome to DB COMICS</h1>
      <h2>Have our heros manage your comics</h2>
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="feature-block">
            ...
            <h4>cloud storage</h4>
            <p>Keep track of your collection by saving it to our cloud</p>
          <!--  <a href="#">read more</a> -->
        ...
        <div class="col-md-6 col-lg-4">
          <div class="feature-block">
            ...
            <p>Our simple user interface allows for easy access</p>
          <!--  <a href="#">read more</a> -->
        ...
        <div class="col-md-6 col-lg-4">
          <div class="feature-block">
            ...
            <h4>Mobile App</h4>
            <p>Download our app and have your collection available offline</p>
          <!--  <a href="#">read more</a> -->
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-md-7 col-lg-5">
          <div class="about-content">
            ...
            <h2><span>DB COMICS</span>UI Design Mobile </h2>
  ...
  <footer class="footer">
    ...
    <div class="copyrights">
      <div class="container">
        <p>&copy; Copyrights DB COMICS. All rights reserved.</p>
        <div class="credits">
          <!--
